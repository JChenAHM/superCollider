...
public class View5 extends BaseView {  
  
	public  int  canvasWidth;
	public  int  canvasHeight;//屏幕宽高
    ...
    public View5(final ColliderFinalActivity c) {  
        super(c);
   ...
   private void create() { 
        ...
        //1
        x=canvasWidth/6+30;
        y=canvasHeight-(canvasHeight*2)/7;
        w=canvasWidth/2;
        h=10f;
        body = createPolygon(x, y, w, h,0.3f,0.5f, true,R.drawable.pillar2,"pillar2");  
        bodyVector.add(body);
        x=canvasWidth/6;
        y=canvasHeight-(canvasHeight*2)/7-30;
        body =createCircle(x,y, 30f, 0.3f, 0.3f, false,R.drawable.ball2,"ball2"); 
        bodyVector.add(body);
        
        //2
        x=canvasWidth/2-canvasWidth/8;
        y=canvasHeight-10-canvasHeight/2;
        w=120f;
        h=10f;
        body = createPolygon(x, y, w, h,0.3f,0.5f, true,R.drawable.pillar2,"pillar2");  
        bodyVector.add(body);
        
        x=canvasWidth/2-canvasWidth/8-70;
        y=canvasHeight-10-canvasHeight/2-30;
        body =createCircle(x,y, 30f, 0.3f, 0.3f, false,R.drawable.ball2,"ball2"); 
        bodyVector.add(body);
        
        x=canvasWidth/2-canvasWidth/8+15;
        y=canvasHeight-10-canvasHeight/2-30;
        ...
        //5
        x=canvasWidth/3-canvasWidth/9;
        y=(canvasHeight*4)/5;
        w=(canvasWidth/6)*2;
        h=15f;
        body = createPolygon(x, y,w, h,0.3f,0.5f, true,R.drawable.pillar2,"bottom");  
        body.setTransform(new Vec2(x/RATE, y/RATE),-85/RATE);
        bodyVector.add(body);
        
        x=(canvasWidth*2)/3-30-canvasWidth/9;
        y=(canvasHeight*7)/8;
        w=(canvasWidth/6)*2;
        h=15f;
        body = createPolygon(x, y,w, h,0.3f,0.5f, true,R.drawable.pillar2,"bottom");  
